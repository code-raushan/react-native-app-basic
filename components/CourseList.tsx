            ...
            renderItem={({ item }) => {
                return (
                    <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                        <View>
                            <Image source={{ uri: `https://cdn.ineuron.ai/assets/uploads/thumbnails/${item.img}` }} style={{ height: 170, width: 170, resizeMode: "contain" }} />
                        </View>
                        <View style={{ display: "flex", flexDirection: "column", width: 140, marginLeft: 20 }}>
